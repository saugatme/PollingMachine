function varargout = Voting(varargin)
...
% Last Modified by GUIDE v2.5 31-Jul-2019 09:05:04

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Voting_OpeningFcn, ...
                   'gui_OutputFcn',  @VotingOutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Voting_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = VotingOutputFcn(hObject, eventdata, handles) 
...
party4 = 0;
party5 = 0;
set(handles.text_party1_votes,'string',num2str(0));
set(handles.text_party2_votes,'string',num2str(0));
set(handles.text_party3_votes,'string',num2str(0));
set(handles.text_party4_votes,'string',num2str(0));
set(handles.text_party5_votes,'string',num2str(0));
set(handles.text_party1_votes_per,'string',num2str(0));
set(handles.text_party2_votes_per,'string',num2str(0));
set(handles.text_party3_votes_per,'string',num2str(0));
set(handles.text_party4_votes_per,'string',num2str(0));
set(handles.text_party5_votes_per,'string',num2str(0));
set(handles.text_total_votes,'string',num2str(0));